...
<head>
    ...
    <title>SPORTSWORLD| New User</title>
       ...
       #boxx
	{
      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit_admin.php">
